...
public class AdhocMatcherLongStepExample implements ExactMatcher {
            ...
            switch (state) {
                case 0:
                    ...
                    if (MatcherHelper.isDigit(c) &&
                            MatcherHelper.isDigit(input.charAt(i + 1)) &&
                            MatcherHelper.isDigit(input.charAt(i + 2))) {
                        state = 3;
                        i += 2;
                    } else {
                        return null;
                ...
                case 5:
                    ...
                    if (MatcherHelper.isDigit(c) &&
                            MatcherHelper.isDigit(input.charAt(i + 1)) &&
                            MatcherHelper.isDigit(input.charAt(i + 2)) &&
                            MatcherHelper.isDigit(input.charAt(i + 3))) {
                        state = 9;
                        i += 3;
                    } else {
                        return null;
